...
object ActorFlow {
  ...
  /**
    ...
    */
  def actorRef[In, Out](props: ActorRef => Props, terminated: () => Unit, bufferSize: Int = 16, overflowStrategy: OverflowStrategy = OverflowStrategy.dropNew)(implicit factory: ActorRefFactory, mat: Materializer): Flow[In, Out, _] = {
